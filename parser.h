...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
        ...
        switch (this->kind ())
    {
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const TokenType& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
...
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, TokenType v)
        : super_type (token_kind_type (tok), std::move (v))
#else
      symbol_type (int tok, const TokenType& v)
    ...
    /// Build a parser object.
     Parser  (Cd::Scanner& scanner_yyarg, Cd::Driver& driver_yyarg);
    virtual ~ Parser  ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_REFER ()
      {
        return symbol_type (token::REFER);
      }
#else
      static
      symbol_type
